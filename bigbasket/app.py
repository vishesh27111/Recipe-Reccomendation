#  This Script runs from app.py of yolov5_flask_integrtion module
...
#
# items = json.load(open('/Users/aryan/Desktop/Python/yolo_v5/Flask_API/bigbasket/items.json'))
#
# @app.route('/')
# def msg():
#     return 'hey'
...
#         items[item_id] = args
#
#         with open('/Users/aryan/Desktop/Python/yolo_v5/Flask_API/bigbasket/items.json', 'w') as fp:
